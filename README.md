...
Verified: default K=2048 at shift507 with 2 workers (11.8k win/s) and with 3 workers (all three clamp to 2048, no OOM); parity at the new default is **54 flights, `windows=2048 bad_windows=0 bad_pairs=0`** (and 48 flights with the right-sized host arrays). Example: `MINING_JUMP2_BATCH=256 FUSED_GPU=1 ./bin/gapminer --crt-file data/crt/m23/shift509_p74_covermax_m38.txt --threads 2 --enable-gpu-fermat` |
